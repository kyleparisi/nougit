...
{var formObject={};var form=html_form_element;var children=form.childNodes;this.each(children,function(){var node_name=this.nodeName;if((node_name==='INPUT')||(node_name==='TEXTAREA'))
